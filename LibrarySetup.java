...
public class LibrarySetup {
    ...
    private ArrayList<BookRead> getUnreadBooks() {
        ...
        for (int i = 0; i < masterList.size(); i++) {
            ...
            // *** INCOMPLETE CODE BELOW (ISREAD METHOD DNE YET): DO WE WANT ANOTHER GETTER FOR BOOKREAD READ STATUS? APPEARS TO BE ANTI-PATTERN. ***
    ...
    public void search() {
        ...
        if (searchMethod.equals("title")) {
            ...
            for (int i = 0; i < ratedList.size(); i++) {
                Book currentBook = ratedList.get(i).getBook();
    ...
    /**
     * Helper method to determine if a user has given a valid method to search for a book.
     * @param input. The String containing a user's input method.
     * @return. True if user input a valid way to search, false if not.
     */
    ...
    public void rate() {
        ...
        // Could potentially use a searchByTitle() method here, meaning in search() we could just call 
